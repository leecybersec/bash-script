...
enum_web_service ()
{
	...
	echo "gobuster dir -q -e -k -u $url:$port -w /usr/share/seclists/Discovery/Web-Content/big.txt -x \$ext &"
	echo "gobuster dir -q -e -k -u $url:$port -w /usr/share/seclists/Discovery/Web-Content/common.txt \$ext &"
	echo "gobuster dir -q -e -k -u $url:$port -w /usr/share/seclists/Discovery/Web-Content/raft-medium-files-lowercase.txt \$ext &"
	echo "gobuster dir -q -e -k -u $url:$port -w /usr/share/seclists/Discovery/Web-Content/directory-list-lowercase-2.3-medium.txt \$ext &"

	printf "\n${GREEN}[+] Using ffuf\n${NC}"
	echo "ffuf -s -w /usr/share/seclists/Discovery/Web-Content/common.txt -u $url:$port/FUZZ -e \$ext &"
	echo "ffuf -s -w /usr/share/seclists/Discovery/Web-Content/raft-medium-files-lowercase.txt -u $url:$port/FUZZ -e \$ext &"
	echo "ffuf -s -w /usr/share/seclists/Discovery/Web-Content/big.txt -u $url:$port/FUZZ -e \$ext &"
	echo "ffuf -s -w /usr/share/seclists/Discovery/Web-Content/directory-list-lowercase-2.3-medium.txt -u $url:$port/FUZZ -e \$ext &"
